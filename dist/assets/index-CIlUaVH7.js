...
`;function Ge(t,e){w(Ke(),ze),e()}const Ze=()=>y`
...
<li><a href="/activities">Activities</a></li>
<li><a href="/about">About us</a></li>
</ul>`;function Ye(t,e){w(Ze(),qe),e()}const Qe=()=>y`
...
`;function rt(){w(nt(fe),U)}const ot=t=>y`
   <div class="bg-white">
  <div class="pt-6">
    <!-- Image gallery -->
...
`;function lt(t){const{id:e}=t.params,i=fe.find(a=>a.id==e);w(ot(i),U)}const ct=()=>y`
...
`;function dt(){w(ct(),U)}v(Ye);v(Ge);v("/",dt);v("/about",Je);v("/book",it);v("/destinations",rt);v("/destinations/:id",lt);v("/activities",et);v.start();
