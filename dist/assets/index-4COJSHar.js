...
`;function Ge(t,e){x(Ke(),ze),e()}const Ze=()=>y`
...
<li><a href="/activities">Activities</a></li>
<li><a href="/about">About us</a></li>
</ul>`;function Ye(t,e){x(Ze(),qe),e()}const Qe=()=>y`
...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" @submit=${st}>
...
`;function rt(){x(nt(fe),U)}const ot=t=>y`
   <div class="bg-white">
  <div class="pt-6">
    <!-- Image gallery -->
...
`;function lt(t){const{id:e}=t.params,i=fe.find(a=>a.id==e);x(ot(i),U)}const ct=()=>y`
...
`;function dt(){x(ct(),U)}v(Ye);v(Ge);v("/",dt);v("/about",Je);v("/book",it);v("/destinations",rt);v("/destinations/:id",lt);v("/activities",et);v.start();
